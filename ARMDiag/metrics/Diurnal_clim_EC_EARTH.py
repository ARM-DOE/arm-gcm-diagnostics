...
#    var=['cld_fraction']
#    basedir='/g/g92/zhang40/calc_stats/ARMDiag/ARMDiag/observation/'
    basedir=homedir+'observation/'
    file_obs=basedir+'ARMdiag_c1_diurnal_climo_plev_1997.nc'
    ####################Model data
#    basedir1='/g/g92/zhang40/calc_stats/ARMDiag/ARMDiag/model/'
    basedir1=moddir
    ...
    for index in range(2):
        ...
        plt.title('cl (%)')
        fig1.savefig('/g/g92/zhang40/calc_stats/ARMDiag/ARMDiag/figures/'+title+'.png')
        #plt.show()
    ...
    for index in range(2):
        ...
        plt.title('cl (%)')
        fig2.savefig('/g/g92/zhang40/calc_stats/ARMDiag/ARMDiag/figures/'+title+'.png')
    #    
    #    plt.show()
    ##########################Annual cycle
    ...
    for index in range(2):
        ...
        plt.title('cl (%)')
        fig.savefig('/g/g92/zhang40/calc_stats/ARMDiag/ARMDiag/figures/'+title+'.png')
    #    
    #    plt.show()
    ...
    for index in range(len(seasons)):
     ...
     #   print index*3+2,(index+1)*3+2
        ...
        fig3.savefig('/g/g92/zhang40/calc_stats/ARMDiag/ARMDiag/figures/'+seasons[index]+'_ARSCL_CFMIP2_EC-EARTH.png')
      #  plt.show()
    ...
    fig0.savefig('/g/g92/zhang40/calc_stats/ARMDiag/ARMDiag/figures/Annual_ARSCL_CFMIP2_EC-EARTH.png')
    
    return ('Finished metrics calculation!' )
