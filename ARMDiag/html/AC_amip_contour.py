...
htmlfile = open('AC_amip_contour.html',"w")
...
#    htmlfile.write('<TH><BR>')
    ...
    #htmlfile.write('<TH><BR>')
    htmlfile.write('<TH ALIGN=LEFT><A HREF="../figures/CFMIP2_EC-EARTH_cl_annual_cycle_clim.png"> Model</a>')
    htmlfile.write('<A HREF="../figures/ARSCL_cl_annual_cycle_clim.png"> Obs.</a>')
    htmlfile.write('<A HREF="../figures/Diff_cl_annual_cycle_clim.png"> Model-Obs.</a>')
    #htmlfile.write('<TH><BR>')
    htmlfile.write('<TH ALIGN=LEFT><A HREF="../figures/ANN_ARSCL_CFMIP2_EC-EARTH.png"> ANN</a>')
    htmlfile.write('<A HREF="../figures/DJF_ARSCL_CFMIP2_EC-EARTH.png"> DJF</a>')
    htmlfile.write('<A HREF="../figures/MAM_ARSCL_CFMIP2_EC-EARTH.png"> MAM</a>')
    htmlfile.write('<A HREF="../figures/JJA_ARSCL_CFMIP2_EC-EARTH.png"> JJA</a>')
    htmlfile.write('<A HREF="../figures/SON_ARSCL_CFMIP2_EC-EARTH.png"> SON</a>')
