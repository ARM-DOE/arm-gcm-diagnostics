...
htmlfile = open('DC_amip_line.html',"w")
...
#  /g/g92/zhang40/calc_stats/figures/
    ...
    htmlfile.write('<TH ALIGN=LEFT><A HREF="../figures/DC_amip_07_pr.png"> Line plot</a>')
    htmlfile.write('<TH ALIGN=LEFT><A HREF="../figures/DC_amip_HarmonicD_07_pr.png"> Harmonic Diagram</a>')
