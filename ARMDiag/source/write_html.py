...
def write_html():
    ...
    <em>Click on Plot Type</em></b><p>
      ...
      <A HREF="AC_amip_contour.html"><img src="../figures/mod_cl_p_annual_cycle_clim.png"   border=1 hspace=3 alt="Set 3" width="70" height="70"></a>
      <A HREF="DC_amip_line.html"><img src="../figures/ANN_cl_p_diff.png "   border=1 hspace=3 alt="Set 3" width="70" height="70"></a>
      <A HREF="DC_amip_contour.html"><img src="../figures/obs_cl_p_diurnal_clim.png"   border=1 hspace=3 alt="Set 3" width="70" height="70"></a>
      <A HREF="Daily_amip_PDF.html"><img src="../figures/Daily_amip_pr_JJA_pdf1.png"   border=1 hspace=3 alt="Set 6" width="70" height="70"></a>
