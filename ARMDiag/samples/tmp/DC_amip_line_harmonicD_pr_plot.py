...
basedir='/g/g92/zhang40/calc_stats/repo/ARMDiag_nc/ARMDiag/'
modellist=['MIROC5','CMCC-CM','inmcm4','CCSM4','GFDL-HIRAM-C180','GFDL-HIRAM-C360','FGOALS-s2','HadGEM2-A','ACCESS1-0','ACCESS1-3']
pr_obs3=np.loadtxt(basedir+'observation/pr_JJA_DC_obs.csv')
pr_cmip3=np.loadtxt(basedir+'cmip/pr_JJA_DC_model_regrid_3x3_correct.csv')
pr_cmip3=pr_cmip3.reshape((3,len(modellist),8))

pr_mod3=np.loadtxt(basedir+'model/pr_JJA_DC_CESM1-CAM5_regrid_3x3_correct.csv')
