...
def annual_cycle_data(parameter):
    ...
    for j, variable in enumerate(variables):
        np.savetxt(output_path+'/metrics/'+variable+'_test_annual_cycle.csv',test_var_season[j,:])
        np.savetxt(output_path+'/metrics/'+variable+'_mmm_annual_cycle.csv',mmm_var_season[j,:])
        np.savetxt(output_path+'/metrics/'+variable+'_cmip_annual_cycle.csv',cmip_var_season[:,j,:])
        np.savetxt(output_path+'/metrics/'+variable+'_obs_annual_cycle.csv',obs_var_season[j,:])
        ...
        np.savetxt(output_path+'/metrics/'+variable+'_obs_annual_cycle_std_corr.csv',obs_sample)
        np.savetxt(output_path+'/metrics/'+variable+'_test_annual_cycle_std_corr.csv',test_sample)
        np.savetxt(output_path+'/metrics/'+variable+'_mmm_annual_cycle_std_corr.csv',mmm_sample)
        np.savetxt(output_path+'/metrics/'+variable+'_cmip_annual_cycle_std_corr.csv',cmip_samples)
...
def annual_cycle_line_plot(parameter):
    ...
    for j, variable in enumerate(variables):
        test_data = genfromtxt(output_path+'/metrics/'+variable+'_test_annual_cycle.csv')
        mmm_data = genfromtxt(output_path+'/metrics/'+variable+'_mmm_annual_cycle.csv')
        obs_data = genfromtxt(output_path+'/metrics/'+variable+'_obs_annual_cycle.csv')
