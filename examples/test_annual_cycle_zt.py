"""
Test parameter file for Annual Cycle ZT (height-time) diagnostics only.
"""

# User defined case id
case_id = 'test_annual_cycle_zt_xarray'
...
# Configuration file with only annual_cycle_zt diagnostics
config_file = 'diags_set3_cmip5.json'  # This contains only set3_annual_cycle_zt diagnostics
...
# Variables to analyze (cloud profile variables)
variables = ['cl_p']  # Cloud fraction profile
